seeimport React, { useEffect, useState } from "react";
import { createRoot } from "react-dom/client";

/* =========================================================
   AIBINU FLEXIPREP CBT ENGINE
   Corrected attempt lifecycle:
...
function App() {
  ...
  async function beginExam() {
    ...
    try {
      ...
      // Use one real start time for both the attempt and the exam.
      const actualStartTime =
        new Date().toISOString();

      // STEP 1: create the Airtable CBT_Attempts record FIRST.
      ...
      // Keep the attempt information in sessionStorage so
      // a submit action can use the exact same attempt.
      ...
      // Only enter the exam after the attempt exists.
      setStage("exam");
    ...
    <div style={styles.page}>
      <header style={styles.header}>
        ...
        <div
          ...
          title={online ? "Internet connection available" : "Internet connection unavailable"}
        >
    ...
    <main style={styles.container}>
      ...
      {!online && (
        <div style={styles.networkWarning}>
          🔴 Internet connection lost. Reconnect before starting an examination.
        </div>
      )}
            ...
            {exams.map(exam => (
              ...
              >
                ...
                <button
                  ...
                  disabled={!online}
                >
                  {online ? "View Examination" : "Offline"}
                </button>
              </div>
            ))}
          </div>
    ...
    <main style={styles.center}>
      <section style={styles.instructionCard}>
        ...
        <div style={styles.instructionList}>
          ...
          <p>
            ⚠️ The examination timer begins when
            you click Start Examination.
          </p>

          <p>
            ⚠️ You may submit before the timer ends.
          </p>

          <p>
            ⚠️ When the timer reaches zero, the
        ...
        {!online && (
          <div style={styles.networkWarning}>
            🔴 Internet connection is required to create and verify your examination attempt.
          </div>
        )}
